...
from PyQt6.QtGui import QColor, QPalette, QBrush #,  QPixmap, QFont,  QIcon
from PyQt6.QtWidgets import QApplication,  QTabWidget, QWidget, QBoxLayout, QVBoxLayout,  QHBoxLayout, QLayout, QGridLayout, QLabel #,  QToolBar,  QToolButton, QApplication
