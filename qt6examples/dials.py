...
from PyQt6.QtCore import Qt,  QTimer,  QRectF, QPointF,  qRound # pyqtSignal, Qt,  QSize, QBasicTimer
from PyQt6.QtGui import QColor,  QPalette, QPainterPath,  QPen #,  QPixmap, QFont,  QIcon, QLinearGradient
from PyQt6.QtWidgets import (QWidget,  QApplication,  QTabWidget,  QGridLayout )
