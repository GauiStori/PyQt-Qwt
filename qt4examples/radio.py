...
from PyQt4.QtGui import (QColor,  QPixmap, QFont,  QIcon,  QPalette, QLinearGradient, QMainWindow,  QWidget,  QToolBar,  QToolButton,  QHBoxLayout,  QLabel,  QApplication,  QSizePolicy, QVBoxLayout,  QFrame )
